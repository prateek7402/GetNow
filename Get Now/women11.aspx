    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/women11.png" class="img-responsive mr-botm" />
                    </a>
                 <h3>QUICK OVERVIEW OF ITEM</h3>
                <p>
Admirers can't help but stare when you're in the Charlotte Lace Contrast Babydoll Dress! The lace contrast 
                    covers the neckline and sleeves for a gorgeous and feminine touch of skin. The 3/4 length bell sleeves 
                    continue on the same trend of the lace to continue the feminine look. The sweetheart, v-neckline flows into a 
                    flowing skirt with a tiered hemline. The flowy style flatters every body type and looks stunning for every occasion! 
                    Just add a pair of nude heels and pearl hair accessories for the wedding guest outfit we're all jealous of!
                    </p>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
                <h3>Charlotte Lace Contrast Babydoll Dress</h3>
                <p>Admirers can't help but stare when you're in the Charlotte Lace Contrast Babydoll Dress! 
                    The lace contrast covers the neckline and sleeves for a gorgeous and feminine touch of skin.
                     The 3/4 length bell sleeves continue on the same trend of the lace to continue the feminine look.
                     The sweetheart, v-neckline flows into a flowing skirt with a tiered hemline. The flowy style flatters 
                    every body type and looks stunning for every occasion! Just add a pair of nude heels
                     and pearl hair accessories for the wedding guest outfit we're all jealous of!
                </p>
                <p>
                    <a href="Payment.aspx" class="btn btn-primary btn-lg" role="button">BUY NOW @ $ 18</a> 
                    <a href="cart1.aspx" class="btn btn-primary btn-lg" role="button">Add to Cart</a>
                </p>
            </div>
