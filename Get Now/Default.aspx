...
<body>
    ...
    <div class="thumbnail">
      <div class="caption">
        <h3>Mens Wear Latest Collection</h3>
        <p>Brand New Clothes </p>
        <p><a href="men.aspx" class="btn btn-primary" role="button">BUY NOW</a></p>
      </div>
    </div>
  </div>
                     <div class=" col-md-6 col-sm-6">
    ...
    <!--Products Section -->
          <div class="container">
            <h3 style="margin-left:30px;">Offers</h3>
            <hr />
            <div class="col-md-6 col-sm-6 text-center">
                <a href="women.aspx" >
                    
                <img  src="img/g1.png" class="img-responsive"/>
                   
                    </a>
            </div>
            <div class="col-md-6 col-sm-6 text-center">
                <a href="women.aspx" >
                <img  src="img/gg.png" class="img-responsive"/>
                    </a>
            </div>
            </div> 
       ...
       <div class="container">
            <h3 style="margin-left:30px;">Womens Collection</h3>
            <hr />
        ...
        <div class="container">
            <h3 style="margin-left:30px;">Mens Collection</h3>
            <hr />
            <div class="col-md-3 col-sm-3 text-center">
                <a href="women5.aspx" >
                    
                <img  src="img/men5.png" class="img-responsive"/>
                   
                    </a>
                <h4>Washed Shirt Flap Pocket</h4>
            </div>
            <div class="col-md-3 col-sm-3 text-center">
                <a href="women6.aspx" >
                <img  src="img/men6.png" class="img-responsive"/>
                    </a>
                 <h4>Checked Slim Shirt</h4>
            </div>
           <div class="col-md-3 col-sm-3 text-center">
                <a href="women7.aspx" >
                <img  src="img/men7.png" class="img-responsive"/>
                    </a>
                <h4>Checked Shirt</h4>
            </div>
           <div class="col-md-3 col-sm-3 text-center">
                <a href="women8.aspx" >
                <img  src="img/men8.png" class="img-responsive"/>
                    </a>
                <h4>Leaf Print Shirt</h4>
            </div>
            </div>
