    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/women13.png" class="img-responsive mr-botm" />
                    </a>
                 <h3>QUICK OVERVIEW OF ITEM</h3>
                <p>
Step out and show the world just how cute you look in the Shelby Floral Tiered Dress! Lightweight woven fabric, 
                    in an adorable floral print, shapes a v-neckline with a single snap closure, sheer elastic-cuffed long flounce sleeves,
                     and an elastic-waist tiered bodice that ends in a mini length. 
                    The Shelby dress makes the perfect brunch outfit paired with strappy sandals and a wide brim hat! 
                    </p>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
                <h3>Shelby Floral Tiered Dress</h3>
                <p>Step out and show the world just how cute you look in the Shelby Floral Tiered Dress! Lightweight woven fabric, 
                    in an adorable floral print, shapes a v-neckline with a single snap closure, sheer elastic-cuffed long flounce sleeves, 
                    and an elastic-waist tiered bodice that ends in a mini length.
                     The Shelby dress makes the perfect brunch outfit paired with strappy sandals and a wide brim hat! 
                </p>
