    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/women10.png" class="img-responsive mr-botm" />
                    </a>
                 <h3>QUICK OVERVIEW OF ITEM</h3>
                <p>
The Emily Belted Jumpsuit is a look that can take you where you wanna go! Lightweight woven fabric sweeps chicly 
                    across this short sleeve, v-neckline jumpsuit with a functional back  button with a keyhole and back zipper. 
                    The Emily jumpsuit also features an elastic waist with a statement straw belt with a faux wooden buckle and wide 
                    flowy skinny pant legs, 
                    making this jumpsuit a stylish choice for day or night! Available in 2 colors
                    </p>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
                <h3>Emily Belted Jumpsuit</h3>
                <p>The Emily Belted Jumpsuit is a look that can take you where you wanna go! 
                    Lightweight woven fabric sweeps chicly across this short sleeve, v-neckline jumpsuit with a 
                    functional back  button with a keyhole and back zipper. The Emily jumpsuit also features an elastic waist with a 
                    statement straw belt with a faux wooden buckle and wide flowy skinny pant legs,
                     making this jumpsuit a stylish choice for day or night! Available in 2 colors 
                </p>
                <p>
