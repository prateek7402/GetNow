    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/women8.png" class="img-responsive mr-botm" />
                    </a>
                 <h3>QUICK OVERVIEW OF ITEM</h3>
                <p>
Happy days never have to end now that the Emma Floral Embroidered Babydoll Dress has arrived!
                     Gauzy woven fabric has an elegant floral print throughout with floral embroidery details across the bust and a functional 
                    button feature. The long elastic-cuffed balloon sleeves and the flowy babydoll bodice finish off this gorgeous mini dress!
                     Pair the Emma dress with platform espadrilles and a wide brim hat for a boho-inspired look!
                    </p>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
                <h3>Emma Floral Embroidered Babydoll Dress</h3>
                <p>Happy days never have to end now that the Emma Floral Embroidered Babydoll 
                    Dress has arrived! Gauzy woven fabric has an elegant floral print throughout with floral embroidery 
                    details across the bust and a functional button feature. The long elastic-cuffed balloon sleeves and the
                     flowy babydoll bodice finish off this gorgeous mini dress! 
                    Pair the Emma dress with platform espadrilles and a wide brim hat for a boho-inspired look!
                </p>
                <p>
