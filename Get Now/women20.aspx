    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/women20.png" class="img-responsive mr-botm" />
                    </a>
                 <h3>QUICK OVERVIEW OF ITEM</h3>
                <p>
It's your time to shine when you slip into the Maren Polka Dot Button Front Tiered Dress! 
                    From date nights out to a fun day with the girls, the Maren is one of those cute dresses you just can't stop thinking of. 
                    The buttons down the front are not functional yet they add the details necessary for completing this stylish look. 
                    The skirt is a drop waist with tiered flowing fabric. This flattering dress has a v-neckline with long button-closure sleeves. 
                    The polka dot speckles are 
                    the main feature of the print however there is a striped background that completes the dress with subtle flattery. !
                    </p>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
                <h3>Bailey Ruffle Hem Maxi Dress</h3>
                <p>It's your time to shine when you slip into the Maren Polka Dot Button Front Tiered Dress! 
                    From date nights out to a fun day with the girls, the Maren is one of those cute dresses you just can't stop thinking of.
                     The buttons down the front are not functional yet they add the details necessary for completing this stylish look.
                     The skirt is a drop waist with tiered flowing fabric. This flattering dress has a v-neckline with long button-closure sleeves. 
                    The polka dot speckles are the main 
                    feature of the print however there is a striped background that completes the dress with subtle flattery. 
                </p>
                <p>
                    <a href="Payment.aspx" class="btn btn-primary btn-lg" role="button">BUY NOW @ $ 44</a> 
