    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/about1.png" class="img-responsive mr-botm" />
                    </a>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
       
                <p>GetNow's heart has never changed - to keep changing the world, one dress at a time.
                     Our goal is to make every experience just that; an experience, not just "shopping".
                    Whether that's online or in store, we hope you enjoy the "Dress Up touch" while shopping with us.
                    We want you to provide best of world. Experience with us once you will get addict to it.
                    We provide diffrent sizes of dresses so you don't need to worry about size just visit and order.
                    Live out your boho dreams in the Dakota Tie-Dye Kimono! 
                </p>
            </div>
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/about3.png" class="img-responsive mr-botm" />
                    </a>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
       
                <p>At the core of the company, GetNow has one main mission - to show the love of Christ and to help customer realize their worth. 
                    Our brand strives to make sure that
                     each customer walking through the doors leaves feeling more confident and loved than they did walking in. 
                </p>
            </div>
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/about4.png" class="img-responsive mr-botm" />
                    </a>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
       
                <p>The idea behind new clothing style every week leads our customer attracted to us. In mall we can see many of shops but there are
                    lack of style and expensive too. Keeping in mind we have the collection of best design from the best designer in affordable prices.
                </p>
            </div>
