    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/women17.png" class="img-responsive mr-botm" />
                    </a>
                 <h3>QUICK OVERVIEW OF ITEM</h3>
                <p>
The Natalie Jersey Knit Midi Dress would love to be your new go-to! Lightweight jersey knit shapes this far from basic dress with short sleeves,
                     a scoop neckline, and a relaxed-fit bodice that flaunts your figure as it flows into a midi length. The Natalie also features 
                    exposed seam detailing throughout and a split 
                    high-low scoop hem which goes perfectly with sneakers or platform sandals! Available in 2 colors.
                    </p>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
                <h3>Natalie Jersey Knit Midi Dress</h3>
                <p>The Natalie Jersey Knit Midi Dress would love to be your new go-to! Lightweight jersey knit shapes this far from basic dress
                     with short sleeves, a scoop neckline, and a relaxed-fit bodice that flaunts your figure as it flows into a midi length. 
                    The Natalie also features exposed seam detailing throughout and a
                     split high-low scoop hem which goes perfectly with sneakers or platform sandals! Available in 2 colors. 
                </p>
                <p>
                    <a href="Payment.aspx" class="btn btn-primary btn-lg" role="button">BUY NOW @ $ 28</a> 
