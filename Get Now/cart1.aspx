...
<body>
    ...
    <div class="container">
           ...
           <!-- /.row -->
        <div class="row">
            <h3 style="margin-left:30px;">Added To Cart</h3>
            <hr />
            <div class="col-md-3 col-sm-3 text-center">
                <a href="women5.aspx" >
                    
                <img  src="img/women5.png" class="img-responsive"/>
                   
                    </a>
                <h4>Maren Polka Dot Button Front Tiered Dress</h4>
            </div>
            <div class="col-md-3 col-sm-3 text-center">
                <a href="women11.aspx" >
                    
                <img  src="img/women11.png" class="img-responsive"/>
                   
                    </a>
                <h4>Charlotte Lace Contrast Babydoll Dress</h4> 
            </div>
             <div class="col-md-3 col-sm-3 text-center">
                <a href="Payment.aspx" class="btn btn-primary btn-lg" role="button">CheckOut</a>
            </div>
            </div>
        <!-- /.row -->
