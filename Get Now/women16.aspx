    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/women16.png" class="img-responsive mr-botm" />
                    </a>
                 <h3>QUICK OVERVIEW OF ITEM</h3>
                <p>
Dressed up or down, the Savannah Jersey Knit Jumpsuit is an instantly cute look! Lightweight and stretchy jersey knit fabric
                     shapes this adorable sleeveless jumpsuit that has a plunging scoop neckline, a functional drawstring waistline,
                     front pocket, side seam pockets and elastic-cuffed pant legs. Pair the Savannah with sneakers or dress it up with a denim 
                    jacket and platform sandals 
                    for an outfit that's sure to catch everyone's eyes! Available in 2 colors.
                    </p>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
                <h3>v</h3>
                <p>Dressed up or down, the Savannah Jersey Knit Jumpsuit is an instantly cute look!
                     Lightweight and stretchy jersey knit fabric shapes this adorable sleeveless jumpsuit that has a plunging scoop neckline, 
                    a functional drawstring waistline, front pocket, side seam pockets and elastic-cuffed pant legs. Pair the Savannah with sneakers 
                    or dress it up with a denim jacket and
                     platform sandals for an outfit that's sure to catch everyone's eyes! Available in 2 colors.
                </p>
                <p>
                    <a href="Payment.aspx" class="btn btn-primary btn-lg" role="button">BUY NOW @ $ 32</a> 
