    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-sm-8 mr-top-50">
                <a href="#" >
                <img  src="img/women7.png" class="img-responsive mr-botm" />
                    </a>
                 <h3>QUICK OVERVIEW OF ITEM</h3>
                <p>
The Reagan Swiss Dot Romper is the perfect one-and-done piece for your spring + summer wardrobe! 
                    This cute romper is designed with a trendy swiss dot texture, a cinched waist with a functional drawstring,
                     lined shorts, and adjustable spaghetti straps. 
                    Style it with an oversized denim jacket and platform espadrilles for a simple, yet adorable outfit!
                    </p>
            </div>
            <div class="col-md-4 col-sm-4 mr-top-50">
                <h3>Reagan Swiss Dot Romper</h3>
                <p>The Reagan Swiss Dot Romper is the perfect one-and-done piece for your spring + summer wardrobe! 
                    This cute romper is designed with a trendy swiss dot texture, a cinched waist with a functional drawstring,
                     lined shorts, and adjustable spaghetti straps.
                     Style it with an oversized denim jacket and platform espadrilles for a simple, yet adorable outfit!
                </p>
                <p>
                    <a href="Payment.aspx" class="btn btn-primary btn-lg" role="button">BUY NOW @ $ 40.00</a> 
